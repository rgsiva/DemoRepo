...
#   And I Click on the Close option in the You have successfully signed out pop up window
    ...
    Examples: 
      ...
      | Regence | authenticated   | QA3         | TESTBLUWANWFFT   | password$1 | medicalProvider        | Search homepage    | 1 TEST DEMO ST, SEATTL... | Salt Lake City, UT              | search_All | Psychology                | Telehealth      |
      | Asuris  | authenticated   | QA3         | TestASURASTest3  | password$1 | medicalProvider        | Search homepage    | 10 BROWN ST, SPOKANE, ... | 10 BROWN ST, SPOKANE, WA 99201  | search_All | dietician                 | Telehealth      |
