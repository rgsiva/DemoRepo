...
#   And I Close the Medical Provider popup Window
    ...
    Examples: 
      ...
      | BSH   | authenticated   | QA3         | TESTBSHWAHSA | password$1 | medicalProvider        | Search homepage    | 10 BROWN ST, SEATTLE, ...| 10 BROWN ST, SEATTLE, WA 98133 | search_All | davis                    | Telehealth     |
