...
Feature: Telehealth Filter Result Validation based on Telehealth Service Search
  ...
  Scenario Outline: Verify Telehealth Service Search
    ...
    Examples: 
      ...
      | Regence | authenticated   | QA3         | TESTBLUWANWFFT  | password$1 | medicalProvider        | Search homepage    | 1 TEST DEMO ST, SEATTL... | Salt Lake City, UT | search_All | Knee Replacement        | Telehealth      |
      | Asuris  | authenticated   | QA3         | TestASURASTest3 | password$1 | medicalProvider        | Search homepage    | 10 BROWN ST, SPOKANE, ... | Seattle, WA        | search_All | Knee Injury             | Telehealth      |
