...
@ExtendedCucumberOptions(
		jsonReport = "target/cucumber-report/Regresssion/cucumber.json", 
...
public class RunCucumberTests_Regression extends AbstractTestNGCucumberTests {
	...
	private void afterClass() {
		...
		Reporter.setSystemInfo("os", "MAC OS"); //Change to Windows if running in Windows
	}
